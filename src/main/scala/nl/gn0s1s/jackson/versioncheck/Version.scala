...
// from https://github.com/apache/pekko/blob/v1.1.0-M1/actor/src/main/scala/org/apache/pekko/util/Version.scala
 ...
 */
private final class Version(val version: String) extends Comparable[Version] {
   ...
   * INTERNAL API
   */
  private[jackson] def parse(): Version = {
